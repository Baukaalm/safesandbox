...
<p align="center">
  <img src="assets/demo.svg" alt="SafeSandbox demo" width="800"/>
  <br/>
  <sup>SafeSandbox automatically captures snapshots as your AI agent edits code — then rollback with one command</sup>
</p>
